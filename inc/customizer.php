...
function _s_customize_preview_js() {
	wp_enqueue_script( '_s-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), filemtime(get_stylesheet_directory().'/js/customizer.js'), true );
}
